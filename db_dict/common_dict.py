class CommonDict():
    ...
    yes_no_other_dict = {'tbd': "To be filled",
                         "other": "Yes", "N": "No", 'na': 'Not done'}
    form_yes_no_dict = {'tbd': "To be filled",
                        'na': 'Not available in report', "N": "No", "Y": "Yes"}
    gender_dict = dict(male='Male', female='Female', other='Other')
    ...
    normal_abnormal_dict = {'tbd': "To be filled",
                            'no': 'Not Present in Report', 'normal': "Normal", 'abnormal': "Abnormal"}
