...
class ClinicalExamForm(SectionForm):
    ...
    fld_palpable_lump_form = SelectField("Palpable lump in the breast?", choices=CommonDict.form_yes_no_choice)
    ...
    fld_discharge_form_present = SelectField("Nipple discharge", choices=CommonDict.form_yes_no_choice)
