...
class MammoMassForm(SectionForm):
    ...
    fld_loc_right_breast = SelectField(
        "Location of mass in Right Breast", choices=MammographyDict.mammo_mass_location_right_breast_choice)
    fld_loc_right_breast_other = StringField("Other")
    fld_loc_left_breast = SelectField(
        "Location of mass in Left Breast", choices=MammographyDict.mammo_mass_location_left_breast_choice)
    fld_loc_left_breast_other = StringField("Other")
    fld_depth = SelectField("Depth of mass detected",
                            choices=MammographyDict.mammo_mass_depth_choice)
    fld_depth_other = StringField("Other")
    fld_dist = SelectField("Distance of mass from nipple",
                           choices=MammographyDict.mammo_mass_dist_choice)
    fld_dist_other = StringField("Other")
    fld_pect = StringField(
        "Distance from Pectoralis Major (cm) if available (NA if not present)")
    fld_shape = SelectField(
        "Shape of mass", choices=MammographyDict.mammo_mass_shape_choice)
    fld_shape_other = StringField("Other")
    fld_margin = SelectField(
        "Margins of mass", choices=MammographyDict.mammo_mass_margin_choice)
...
class MammoCalcificationForm(SectionForm):
    ...
    fld_loc_left_breast_other = StringField("Other")
    fld_depth = SelectField("Depth of Calcification",
                            choices=MammographyDict.mammo_calc_depth_choice)
    fld_depth_other = StringField("Other")
    fld_dist = SelectField("Distance of calcification from nipple",
                           choices=MammographyDict.mamo_calc_dist_choice)
    fld_dist_other = StringField("Other")
    fld_type = SelectField(
        "Calcification Type", choices=MammographyDict.mammo_calcification_type_choice)
    fld_type_other = StringField("Other")
    fld_diagnosis = SelectField(
        "Calcification Diagnosis", choices=MammographyDict.mammo_calcification_diagnosis_choice)
...
class MammoArchDistortionsForm(BaseForm):
    ...
    fld_loc_left_breast_other = StringField("Other")
    fld_depth = SelectField("Depth of Architectural Distortion",
                            choices=MammographyDict.mammo_arch_depth_choice)
    fld_depth_other = StringField("Other")
    fld_dist = StringField(
        "Distance of Architectural Distortion from nipple (cm)")
...
class MammoAssymetryForm(BaseForm):
    ...
    fld_depth = SelectField("Depth of asymmetry",
                            choices=MammographyDict.mammo_assym_depth_choice)
    fld_depth_other = StringField("Other")
...
class AssoFeatureForm(BaseForm):
    fld_skin_retraction = SelectField(
        "Skin Retraction", choices=CommonDict.absent_present_choice)
    fld_skin_retraction_other = StringField("Other")
    fld_nipple_retraction = SelectField(
        "Nipple Retraction", choices=CommonDict.absent_present_choice)
    fld_nipple_retraction_other = StringField("Other")
    fld_skin_thickening = SelectField(
        "Skin Thickening", choices=CommonDict.absent_present_choice)
    fld_skin_thickening_other = StringField("Other")
    fld_trabecular_thickening = SelectField(
        "Trabecular Thickening", choices=CommonDict.absent_present_choice)
    fld_trabecular_thickening_other = StringField("Other")
    fld_axillary_adenopathy = SelectField(
        "Axillary Adenopathy", choices=CommonDict.absent_present_choice)
    fld_axillary_adenopathy_other = StringField("Other")
    fld_architectural_distortion = SelectField(
        "Architectural Distortion", choices=CommonDict.absent_present_choice)
    fld_architectural_distortion_other = StringField("Other")
    fld_calcifications_other = StringField("Other")
    fld_calcifications = SelectField(
        "Calcification", choices=CommonDict.absent_present_choice)
...
class MammographyForm(SectionForm):
    ...
    fld_mammo_location = SelectField(
        'Mammography Diagnosis at', choices=MammographyDict.mammo_location_choice)
    fld_mammo_details = SelectField(
    ...
    mammography_architectural_distortions_form = FormField(
        MammoArchDistortionsForm)
    fld_mammography_asymmetry_form_present = SelectField(
        "Are Asymmetries present", choices=CommonDict.form_yes_no_choice)
    ...
    fld_mammo_intra_mammary_lymph_nodes_description = TextAreaField(
    ...
    fld_mammo_birad = SelectField(
        "BI-RAD classification (if available)", choices=MammographyDict.mammo_birad_choice)
