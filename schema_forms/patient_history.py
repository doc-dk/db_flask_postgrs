...
class PatientHistoryForm(SectionForm):
    ...
    fld_nutrition_supplement_form_present = SelectField("Nutritional Supplement taken?", choices=CommonDict.yes_no_choice)
    nutrition_supplement_form = FormField(NutritionalSupplementsForm)
    fld_physical_activity_form_present = SelectField("Any physical activity done?", choices=CommonDict.yes_no_choice)
    physical_activity_form = FormField(PhysicalActivityForm)
