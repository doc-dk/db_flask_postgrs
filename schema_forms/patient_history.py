...
class PatientHistoryForm(SectionForm):
    fld_med_rec_no = StringField('Medical Record Number')
    ...
    fld_menopause_age = IntegerField('Age at Menopause', default = 50)
    fld_menopause_complications = StringField("Complications associated with menopause")
    ...
    fld_age_first_child = IntegerField('Age of first child',default= 50)
    fld_age_first_pregnancy = IntegerField('Age at first pregnancy', default=50)
    fld_age_last_pregnancy = IntegerField('Age at last pregnancy', default=50)
...
#breast feeding detail table
    ...
    fld_duration_current_complain = StringField("Duration of current complains")
